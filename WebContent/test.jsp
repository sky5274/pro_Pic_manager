...
<script type="text/javascript"
	src="http://cdn.bootcss.com/sockjs-client/1.1.4/sockjs.min.js"></script>
<script type="text/javascript"
	src="http://cdn.bootcss.com/stomp.js/2.3.3/stomp.min.js"></script>
    ...
    <script type="text/javascript">  
        ...
        function connect() {  
            ...
            if ('WebSocket' in window) {  
                ws= new WebSocket("ws://localhost:8080/picShow/websck.do");  
                console.log("ws://localhost:8080/picShow/websck.do");  
            }else {  
                ws = new SockJS("http://localhost:8080/picShow/sockjs/websck");  
                console.log("http://localhost:8080/picShow/sockjs/websck");  
            }  
